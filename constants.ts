export const INITIAL_SERVICE_ITEMS = [
  {
    ...
    "categoryKey": "video",
    "badge": "BEST",
    "title": "바이럴 훅 (Viral Hook)",
    "desc": "시청자의 시선을 3초 안에 사로잡는 강렬한 도입부 영상입니다.",
    "inputs": [],
    "results": [
      "https://youtube.com/shorts/l4TGmEup-sU?feature=share",
      "https://youtube.com/shorts/hBuIswrA078?feature=share",
      "https://youtube.com/shorts/glXvtpzlqjs?feature=share",
      "https://youtube.com/shorts/zgsAlKJ6nD8?feature=share",
      "https://youtube.com/shorts/MJsBL0_Y8ao?feature=share",
      "https://youtube.com/shorts/Mdd-Y7tWFhE?feature=share",
      "https://youtube.com/shorts/hR09-2Jgjfg?feature=share",
      "https://youtube.com/shorts/G1fDSNwHLD0?feature=share",
      "https://youtube.com/shorts/-sDM4yEsEww?feature=share",
      "https://youtube.com/shorts/VHgZ2Zm9n34?feature=share",
      "https://youtube.com/shorts/8vV7t9IipQk?feature=share",
      "https://youtube.com/shorts/zk8-AZMwT4U?feature=share",
      "https://youtube.com/shorts/mdctmj2O3kU?feature=share",
      "https://youtube.com/shorts/IfeSfK1yv3c?feature=share",
      "https://youtube.com/shorts/7y4eVpHmlRs?feature=share",
      "https://youtube.com/shorts/YZ9PMrg793c?feature=share",
      "https://youtube.com/shorts/XaJoC4oIMM4?feature=share"
    ],
    "aiSite": "Runway Gen-2",
  ...
  },
  {
    ...
    "badge": "",
    "title": "언박싱 (Unboxing)",
    "desc": "제품의 포장을 뜯고 구성품을 보여주는 생동감 넘치는 리뷰 영상입니다.",
    "inputs": [],
    "results": [
  ...
  },
  {
    ...
    "categoryKey": "video",
    "badge": "HOT",
    "title": "구매 유도 스킷 (Sales Skit)",
    "desc": "짧은 상황극을 통해 자연스럽게 구매 욕구를 자극하는 영상입니다.",
    "inputs": [],
    "results": [
  ...
  },
  {
    ...
    "categoryKey": "video",
    "badge": "",
    "title": "POV 시점 (First Person View)",
    "desc": "사용자 시점에서 제품이나 공간을 체험하는 듯한 몰입감 있는 영상입니다.",
    "inputs": [],
    "results": [
  ...
  },
  {
    ...
    "badge": "",
    "title": "데일리룩 (OOTD)",
    "desc": "오늘의 의상 스타일링을 감각적으로 보여주는 패션 숏폼입니다.",
    "inputs": [],
    "results": [
  ...
  },
  {
    ...
    "badge": "",
    "title": "ASMR (Sensory)",
    "desc": "시각적, 청각적 자극을 극대화하여 제품의 질감을 전달하는 영상입니다.",
    "inputs": [],
    "results": [
  ...
  },
  {
    ...
    "categoryKey": "video",
    "badge": "",
    "title": "코디 체인지 (Outfit Swap)",
    "desc": "음악에 맞춰 순식간에 의상이 바뀌는 트렌디한 챌린지 영상입니다.",
    "inputs": [],
    "results": [
  ...
  },
  {
    ...
    "categoryKey": "video",
    "badge": "",
    "title": "비주얼 이펙트 (Visual FX)",
    "desc": "화려한 시각 효과로 제품을 돋보이게 만드는 고퀄리티 연출입니다.",
    "inputs": [],
    "results": [
  ...
  },
  {
    ...
    "categoryKey": "video",
    "badge": "NEW",
    "title": "헬스 데이터 (Fitness Data)",
    "desc": "운동 기록과 신체 변화를 다이내믹한 인포그래픽으로 시각화합니다.",
    "inputs": [],
    "results": [
  ...
  },
  {
    ...
    "categoryKey": "video",
    "badge": "HOT",
    "title": "트렌딩 코믹 (Comedy Meme)",
    "desc": "최신 밈(Meme)과 유머 코드를 섞어 공유를 부르는 바이럴 영상입니다.",
    "inputs": [],
    "results": [
